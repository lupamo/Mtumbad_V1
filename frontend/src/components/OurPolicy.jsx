...
const OurPolicy = () => {
	return (
		<div className="flex flex-col sm:flex-row justify-around gap-6 text-center py-10 text-xs sm:text-smm md:text-base text-gray-700">
			<div className="border border-1 bg-gray border-gray-200 p-5 rounded w-80 text-center">
				...
				<p className="text-gray-400">we provide hassle free 7 days return Policy</p>
			</div>
