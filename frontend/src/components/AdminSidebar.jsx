	...
	return(
		<div className="w-[20%] min-h-screen border-r-2">
			<div className="flex flex-col gap-4 pt-6 pl-[20%] text-[15px]">
				...
				<button onClick={() => setActiveComponent('orders')} className={`flex items-center gap-3 border border-gray-400 border-r-0 px-3 py-2 rounded-l ${activeComponent === 'orders' ? 'bg-blue-100' : ''}`}>
